        ...
        <template v-if="type === '5'">
          <div class="weui-media-box weui-media-box_text" v-for="item in list" @click.prevent="onItemClick(item)">
            <div class="weui-media-box_appmsg">
              <div class="weui-media-box__bd">
                <h4 class="weui-media-box__title" v-html="item.title"></h4>
                <p v-for="data in item.desc" v-html="data" style="color: #444;"></p>
              </div>
              <div class="weui-media-box__hd" v-if="item.otherMeta.src" style="line-height:normal;">
                <img class="weui-media-box__thumb" style="display: block;" @error="onImgError(item, $event)"
                     :src="item.otherMeta.src" alt="">
                <p v-html="item.otherMeta.level"></p>
              </div>
