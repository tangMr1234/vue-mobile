<template>
  <div class="custom_warp">
    ...
    <b-scroll class="wrapper" style="height: calc(100% - 46px);" ref="scroll">
      <div class="content">
        <!-- 数据出错时的加载按钮 -->
        <div class="refer_button" @click="getContentData" v-show="load_Button"><i
          class="iconfont icon-shuaxin1"> 点击刷新</i></div>
        <div v-if="CommentData&&CommentData!=''">
          <!-- 顶部图文标题 -->
          ...
          <div v-if="CommentData.swiperImg">
            ...
            <!-- 弹出大图轮播 -->
            <div v-transfer-dom>
              <previewer :list="CommentData.swiperImg" ref="previewer" :options="options"></previewer>
            </div>
          </div>
          <!-- 应用介绍 -->
