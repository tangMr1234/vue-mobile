<template>
  <div class="custom_warp hidden">
    <div ref="getHeight">
      <group :gutter="0">
        <cell :inline-desc="car_data.comment">
          <div slot="title" style="padding-bottom:10px;"><span>{{car_data.title}}</span><span style="float:right;">{{car_data.date}}</span>
          </div>
        </cell>
        <cell :title="car_data.other"></cell>
      </group>
    </div>
